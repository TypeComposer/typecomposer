...
export class PopUpButton extends Component {
  ...
  constructor(props: ElementType & { buttonText?: string; buttonIcon?: string; options: HTMLElement[]; hover?: boolean }) {
    super(props);
...
TypeComposer.defineElement(PopUpButton.TAG, PopUpButton);
