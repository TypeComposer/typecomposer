...
export class FlowPanel extends Component {
  static readonly TAG: string = "tc-flow-panel";
  constructor(props?: ElementType) {
    super({ ...props, style: { overflow: "hidden", ...props?.style } });
    this.addClassName("flow-panel");
  }
...
TypeComposer.defineElement(FlowPanel.TAG, FlowPanel);
