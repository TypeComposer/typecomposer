...
export class TabPanel extends BorderPanel {
  ...
  constructor(
    ...
    if (props != undefined && props?.closeable != undefined) this._closeable = props.closeable;
    if (props != undefined && props?.alignTab != undefined) this.tabs.style.justifyContent = props.alignTab;
  }
...
TypeComposer.defineElement(TabPanel.TAG, TabPanel);
